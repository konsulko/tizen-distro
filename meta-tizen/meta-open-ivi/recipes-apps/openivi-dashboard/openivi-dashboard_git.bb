...
SRC_URI += "git://github.com/konsulko/openivi-dashboard.git;branch=master;tag=720b0fb5d1588e6a0986e13c4e2ad96e16e6be01"
...
do_install() {
 ...
 zip -r ${D}/opt/usr/apps/.preinstallWidgets/openivi-dashboard.wgt config.xml manifest.json css icon.png index.html js
}
